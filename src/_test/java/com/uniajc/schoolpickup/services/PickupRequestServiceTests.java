...
public class PickupRequestServiceTests {
  ...
  @Mock private PickupRequestRepository repository;

  @InjectMocks private PickupRequestService service;
  ...
  public void test_UpdateEntity_Success() throws Exception {
    ...
    Optional<PickupRequest> updatedPickupRequest =
        service.updateEntity(pickupRequest.getId(), pickupRequest);
