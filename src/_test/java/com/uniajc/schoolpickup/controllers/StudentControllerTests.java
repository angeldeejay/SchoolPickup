...
public class StudentControllerTests {
  ...
  public void test_FindAllEntities_Admin_Success() throws Exception {
    ...
    List<Student> foundStudents =
        JsonUtil.toInstances(jsonResponse, new TypeReference<List<Student>>() {});
  ...
  public void test_GetById_Admin_Success() throws Exception {
    ...
    Student foundStudent =
        JsonUtil.toInstance(result.getResponse().getContentAsString(), Student.class);
  ...
  public void test_Update_Admin_Success() throws Exception {
    ...
    // Service mock definition
    given(studentService.updateEntity(isA(Long.class), isA(Student.class)))
