...
public class PickupRequestControllerTests {
  ...
  @MockBean private PickupRequestService pickupRequestService;
  ...
  public void test_FindAllEntities_Admin_Success() throws Exception {
    ...
    List<PickupRequest> foundPickupRequests =
        JsonUtil.toInstances(jsonResponse, new TypeReference<List<PickupRequest>>() {});
  ...
  public void test_GetById_Admin_Success() throws Exception {
    ...
    // Controller response assertions
    PickupRequest foundPickupRequest =
        JsonUtil.toInstance(result.getResponse().getContentAsString(), PickupRequest.class);
  ...
  public void test_Add_Admin_Success() throws Exception {
    ...
    // Controller response assertions
    PickupRequest createdPickupRequest =
        JsonUtil.toInstance(result.getResponse().getContentAsString(), PickupRequest.class);
