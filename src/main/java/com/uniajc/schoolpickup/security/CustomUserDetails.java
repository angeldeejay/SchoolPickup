...
public class CustomUserDetails extends org.springframework.security.core.userdetails.User implements UserDetails {
    ...
    public CustomUserDetails(User user) {
        super(user.getEmail(), user.getPassword(), CustomUserDetails.extractAuthoritiesFromUserDetails(user));
        this.user = user;
    }

    @Override
    public Collection<GrantedAuthority> getAuthorities() {
        return (Collection<GrantedAuthority>) CustomUserDetails.extractAuthoritiesFromUserDetails(this.user);
    }

    protected static Collection<? extends GrantedAuthority> extractAuthoritiesFromUserDetails(User user) {
